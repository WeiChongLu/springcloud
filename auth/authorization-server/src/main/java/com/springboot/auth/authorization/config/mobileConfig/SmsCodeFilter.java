...
import com.springboot.auth.authorization.controller.ValidateController;
...
public class SmsCodeFilter extends OncePerRequestFilter {
    ...
    private void validateSmsCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ...
        ValidateCode codeInSession = (ValidateCode) sessionStrategy.getAttribute(servletWebRequest, ValidateController.SESSION_KEY_SMS_CODE + mobile);
